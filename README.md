...
- 💡 A ideia é usar as linguagens e ferramentas para criar um aplicativo em que tenha uma pagina de login (usando FireBase ferramenta para o banco) e que logo em seguida carrega uma pagina utilizando alguma API mostrando os personagens, alem tambem com um botão com a função de retornar a tela.
